<div class="actions">
	<ul>
        ...
        <li><?php echo $html->link(__('Edit Dana', true), array('action'=>'admin_edit', $dana['Dana']['id'])); ?> </li>
        <li><?php echo $html->link(__('Delete Dana', true), array('action'=>'admin_delete', $dana['Dana']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $dana['Dana']['id'])); ?> </li>
