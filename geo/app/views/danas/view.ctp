...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Edit Dana', true), array('action'=>'edit', $dana['Dana']['id'])); ?> </li>
		<li><?php echo $html->link(__('Delete Dana', true), array('action'=>'delete', $dana['Dana']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $dana['Dana']['id'])); ?> </li>
